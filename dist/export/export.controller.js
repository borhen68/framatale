...
let ExportController = class ExportController {
    ...
    async createExport(request, user) {
    ...
    async downloadExport(jobId, user, res) {
...
__decorate([
    (0, common_1.Post)(),
    (0, swagger_1.ApiOperation)({ summary: 'Create an export job' }),
    (0, swagger_1.ApiResponse)({ status: 201, description: 'Export job created successfully' }),
...
__decorate([
    (0, common_1.Get)('jobs'),
    (0, swagger_1.ApiOperation)({ summary: 'Get all user export jobs' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Jobs retrieved successfully' }),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], ExportController.prototype, "getUserJobs", null);
__decorate([
